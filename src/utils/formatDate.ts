...
export function formatDateText(dateString: string | null, isYearly: boolean, t: (key: string) => string): string {
...
export function formatPeriod(start: string, end: string | null, isCurrent: boolean, isYearly: boolean, t: (key: string) => string): string {
